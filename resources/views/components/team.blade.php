            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="testimonial-item">
                        <img src="assets/img/testimonials/avatar-m.png" class="testimonial-img" alt="">
                        <h3>Oliver Tojo</h3>
                        <h4>Developer &amp; Data science</h4>
                        <div class="stars">
                ...
                <div class="swiper-slide">
                    <div class="testimonial-item">
                        <img src="assets/img/testimonials/avatar-f.png" class="testimonial-img" alt="">
                        <h3>Sarah Wilsson</h3>
                        <h4>Designer</h4>
                        <div class="stars">
                            <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
